...
const QHash<QString, IconDescriptor>& iconRegistry()
{
    static const QHash<QString, IconDescriptor> registry {
        ...
        { QStringLiteral("omodsim/clear"),                     { QStringLiteral(":/res/edit-delete.svg"),               QStringLiteral(":/res/edit-delete.png") } },
        ...
        { QStringLiteral("omodsim/export"),                    { QStringLiteral(":/res/icon-export.svg"),               QStringLiteral(":/res/icon-export.png") } },
