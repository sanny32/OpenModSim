...
const QHash<QString, IconDescriptor>& iconRegistry()
{
    static const QHash<QString, IconDescriptor> registry {
        ...
        { QStringLiteral("omodsim/clear"),                     { QStringLiteral("action/clear"),                        QStringLiteral(":/res/edit-delete.png") } },
        ...
        { QStringLiteral("omodsim/github"),                    { QStringLiteral(":/res/emblem-github.svg"),             QStringLiteral(":/res/emblem-github.png") } },
