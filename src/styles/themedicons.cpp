...
const QHash<QString, IconDescriptor>& iconRegistry()
{
    static const QHash<QString, IconDescriptor> registry {
        ...
        { QStringLiteral("omodsim/clear"),                     { QStringLiteral("edit-clear"),                  QStringLiteral(":/res/edit-delete.png") } },
        ...
        { QStringLiteral("omodsim/export"),                    { QStringLiteral("document-send"),               QStringLiteral(":/res/icon-export.png") } },
        { QStringLiteral("omodsim/force-coils"),               { QStringLiteral("omodsim/force-coils"),         QStringLiteral(":/res/icon-force-coils.png") } },
        { QStringLiteral("omodsim/force-discretes"),           { QStringLiteral("omodsim/force-discretes"),     QStringLiteral(":/res/icon-force-discretes.png") } },
        { QStringLiteral("omodsim/github"),                    { QStringLiteral("omodsim/github"),              QStringLiteral(":/res/emblem-github.png") } },
        { QStringLiteral("omodsim/hex-view"),                  { QStringLiteral("software/command-line"),       QStringLiteral(":/res/icon-hex-view.png") } },
        ...
        { QStringLiteral("omodsim/preset-holding-registers"),  { QStringLiteral("omodsim/preset-holding-registers"), QStringLiteral(":/res/icon-preset-holding-regs.png") } },
        { QStringLiteral("omodsim/preset-input-registers"),    { QStringLiteral("omodsim/preset-input-registers"),   QStringLiteral(":/res/icon-preset-input-regs.png") } },
        ...
        { QStringLiteral("omodsim/save-project"),              { QStringLiteral("action/save"),                 QStringLiteral(":/res/icon-save.png") } },
        ...
        { QStringLiteral("omodsim/split-view"),                { QStringLiteral("ui-panels-right"),             QStringLiteral(":/res/icon-split-view.png") } },
