const translations = {
    en: {
        ...
        'macos.drag': 'Drag Open ModSim.app to the Applications folder',
        ...
        'macos.remove': 'Move Open ModSim.app to Trash or run',
    ...
    ru: {
        ...
        'macos.drag': 'Перетащите Open ModSim.app в папку Applications',
        ...
        'macos.remove': 'Переместите Open ModSim.app в корзину или выполните',
