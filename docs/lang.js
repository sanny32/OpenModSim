const translations = {
    en: {
        ...
        'feature6.desc': 'Available for Windows 7+, macOS 11+, and major Linux distributions (Debian, Ubuntu, Fedora, Rocky, OpenSUSE, Alt Linux, Astra Linux, RedOS) with native performance',
        ...
        'card.macos.title': 'macOS DMG Package',
        ...
        'btn.download.macos': 'Download macOS DMG',
        ...
        'macos.open.dmg': 'Open the DMG package',
        'macos.drag': 'Drag Open ModSim 2.app to the Applications folder',
        'macos.quarantine.tip': 'Before the first launch, allow the application to run in <code>System Settings</code> &gt; <code>Privacy &amp; Security</code>, or remove the quarantine attribute',
        'macos.run': 'Run the application',
        'macos.remove': 'Move Open ModSim 2.app to Trash or run',
    ...
    ru: {
        ...
        'feature1.desc': 'Поддержка всех стандартных функций Modbus: чтение/запись флагов, чтение дискретных входов, чтение регистров ввода, чтение/запись регистров хранения',
        ...
        'feature5.title': 'Скрипты',
        'feature5.desc': 'Поддержка скриптов ECMAScript/JavaScript для сложных сценариев симуляции. Запуск скриптов однократно или периодически с полным доступом к значениям регистров и флагов',
        'feature6.title': 'Кроссплатформенность',
        'feature6.desc': 'Доступен для Windows 7+, macOS 11+ и основных дистрибутивов Linux (Debian, Ubuntu, Fedora, Rocky, OpenSUSE, Alt Linux, Astra Linux, RedOS) с нативной производительностью',
        ...
        'card.macos.title': 'Пакет macOS DMG',
        ...
        'btn.download.macos': 'Скачать macOS DMG',
        ...
        'macos.open.dmg': 'Откройте пакет DMG',
        'macos.drag': 'Перетащите Open ModSim 2.app в папку Applications',
        'macos.quarantine.tip': 'Перед первым запуском разрешите запуск приложения в <code>System Settings</code> &gt; <code>Privacy &amp; Security</code> или удалите атрибут quarantine',
        'macos.run': 'Запустите приложение',
        'macos.remove': 'Переместите Open ModSim 2.app в корзину или выполните',
    ...
    zh_CN: {
        ...
        'feature6.title': '跨平台',
        'feature6.desc': '适用于 Windows 7+、macOS 11+ 和主要 Linux 发行版（Debian、Ubuntu、Fedora、Rocky、OpenSUSE、Alt Linux、Astra Linux、RedOS），具有原生性能',
        ...
        'macos.open.dmg': '打开 DMG 软件包',
        'macos.drag': '将 Open ModSim 2.app 拖到 Applications 文件夹',
        'macos.quarantine.tip': '首次启动前，请在 <code>System Settings</code> &gt; <code>Privacy &amp; Security</code> 中允许应用运行，或移除 quarantine 属性',
        'macos.run': '运行应用程序',
        'macos.remove': '将 Open ModSim 2.app 移到废纸篓，或运行',
        'build.title': '从源码构建',
    ...
    zh_TW: {
        ...
        'feature6.title': '跨平台',
        'feature6.desc': '適用於 Windows 7+、macOS 11+ 和主要 Linux 發行版（Debian、Ubuntu、Fedora、Rocky、OpenSUSE、Alt Linux、Astra Linux、RedOS），具有原生性能',
        ...
        'macos.open.dmg': '打開 DMG 套件',
        'macos.drag': '將 Open ModSim 2.app 拖到 Applications 資料夾',
        'macos.quarantine.tip': '首次啟動前，請在 <code>System Settings</code> &gt; <code>Privacy &amp; Security</code> 中允許應用程式執行，或移除 quarantine 屬性',
        'macos.run': '執行應用程式',
        'macos.remove': '將 Open ModSim 2.app 移到垃圾桶，或執行',
        'build.title': '從原始碼構建',
